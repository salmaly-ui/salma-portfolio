        ...
        <div className="mx-auto max-w-5xl flex items-center justify-between px-6 py-3">
          ...
          <div className="flex items-center gap-4">
            <nav className="hidden md:flex gap-7 text-sm font-medium">
              <NavLink to="/projects" className="hover:text-emerald-600 dark:hover:text-emerald-400 transition">Projets</NavLink>
              <NavLink to="/experience" className="hover:text-emerald-600 dark:hover:text-emerald-400 transition">Expériences</NavLink>
              <NavLink to="/education" className="hover:text-emerald-600 dark:hover:text-emerald-400 transition">Formation</NavLink>
              <NavLink to="/certifications" className="hover:text-emerald-600 dark:hover:text-emerald-400 transition">Certifications</NavLink>
              <NavLink to="/contact" className="hover:text-emerald-600 dark:hover:text-emerald-400 transition">Contact</NavLink>
            </nav>
